...
public class QaAdapter extends RecyclerView.Adapter<QaAdapter.ViewHolder>  {
    ...
    @NonNull
    @Override
    public QaAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull QaAdapter.ViewHolder viewHolder, int position) {
